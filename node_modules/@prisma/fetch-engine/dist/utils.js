...
function getDownloadUrl(channel, version, platform, binaryName, extension = ".gz") {
  ...
  const finalExtension = platform === "windows" && import_download.BinaryType.QueryEngineLibrary !== binaryName ? `.exe${extension}` : extension;
  if (binaryName === import_download.BinaryType.QueryEngineLibrary) {
