...
__export(src_exports, {
  assertNodeAPISupported: () => import_assertNodeAPISupported.assertNodeAPISupported,
  getNodeAPIName: () => import_getNodeAPIName.getNodeAPIName,
  getPlatform: () => import_getPlatform.getPlatform,
  getPlatformInfo: () => import_getPlatform.getPlatformInfo,
  getos: () => import_getPlatform.getos,
  link: () => import_link.link,
  platforms: () => import_platforms.platforms
});
module.exports = __toCommonJS(src_exports);
var import_assertNodeAPISupported = require("./assertNodeAPISupported");
